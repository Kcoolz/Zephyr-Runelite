...
public class Configuration {
	...
	public static final String CACHE_LINK = "https://zephyr-rsps.net/.RuneRogueNew.zip";
	...
	public static final String CLIENT_TITLE = "Zephyr";
	public static final String WEBSITE = "";
	public static final String DEDICATED_SERVER_ADDRESS = "89.117.72.178";
	public static final String TEST_SERVER_ADDRESS = LOCAL_HOST ? "89.117.72.178" : "89.117.72.178";
	public static final int PORT = 43594;
	public static final int TEST_PORT = 43595;
	public static final int CACHE_FOLDER_VERSION = 1;
	public static final String CACHE_NAME = ".RuneRogueNew";
